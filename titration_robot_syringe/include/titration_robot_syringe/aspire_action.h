#ifndef ASPIRE_ACTION_H
#define ASPIRE_ACTION_H
...
class AspireAction : public BT::StatefulActionNode {
public:
    using Syringe = titration_robot_interfaces::srv::Syringe;

    AspireAction(const std::string& name, const BT::NodeConfiguration& config, rclcpp::Node::SharedPtr node_ptr) 
